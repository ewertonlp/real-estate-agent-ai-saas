  ...
  return (
    ...
    <div className="relative w-full overflow-hidden md:h-[450px]  bg-gradient-to-tr from-[#1B45B4] to-[#1C2792] clip-polygon-footer">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl w-full mx-auto px-3 lg:px-0 pt-16 mt-16 z-10">
        ...
        <div className="">
          <h2 className="mb-8 font-medium">Serviço</h2>
          <nav className="text-white ">
            <ul className="flex-col gap-4">
              <li>
                <Link
                  href="/services"
                  className="text-white hover:text-neutral-300 py-1 text-sm flex items-center space-x-1 transition-all"
                >
                  <span>Sobra a AuraSync</span>
                </Link>
              </li>
              <li>
                <Link
                  href="/tutorial"
                  className=" hover:text-neutral-300 py-1  text-sm flex items-center space-x-1 transition-all"
                >
                  Tutorial
                </Link>
              </li>
              ...
              <li>
                <Link
                  href="/login"
                  className="py-1 text-sm flex items-center space-x-1 transition-all"
                >
                  Login
                </Link>
              </li>
          ...
          <nav className="">
            <ul className="flex-col gap-4 list-none -pl-2">
              <li>
                <Link
                  href="/aboutUs"
                  className="py-1 hover:text-neutral-300 text-sm flex items-center space-x-1 transition-all"
                >
                  Sobre nós
                </Link>
              </li>
      ...
      <div className="mt-8 border-t-[1px] border-border/50 max-w-7xl mx-auto pb-4">
        <div className="px-3 lg:px-0 mt-4 flex flex-col items-center gap-4 md:flex-row md:justify-between md:items-center">
          <div className="flex flex-col gap-2 md:flex-row md:gap-4">
            <Link
              href="/privacidade"
              className="text-white hover:text-neutral-300 py-1 text-sm transition-all text-center md:text-left" /* text-center para mobile */
            >
              Privacidade
            </Link>
