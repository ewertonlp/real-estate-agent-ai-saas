...
export default function DashboardPage() {
  ...
  const buildPrompt = () => {
    ...
    if (contentType)
      basePrompt += ` O formato do conteúdo deve ser: ${contentType}.`;
    ...
    if (optimizeForSeoGmb) {
      ...
      if (seoKeywords)
        basePrompt += ` Inclua as seguintes palavras-chave SEO: "${seoKeywords}".`;
      if (propertyAddress)
        basePrompt += ` O endereço do imóvel é: "${propertyAddress}".`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      isBasicFormEmpty &&
      (!optimizeForSeoGmb || (optimizeForSeoGmb && isSeoGmbFormEmpty))
    ) {
      setError(
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="Famílias com crianças">Famílias com crianças</option>
        ...
        <div className="border-t pt-10 mt-10">
          ...
          <div>
            ...
            >
              ...
              <option value="Descrição Detalhada para Site">
                Descrição Detalhada para Site
              </option>
              <option value="Legenda Curta para Instagram">
                Legenda Curta para Instagram
              </option>
              <option value="Mensagem Direta para WhatsApp">
                Mensagem Direta para WhatsApp
              </option>
              <option value="Roteiro para Stories/Reels">
                Roteiro para Stories/Reels
              </option>
            </select>
          </div>
          {/* Incluir Emojis */}
          ...
          <div className="flex items-center mt-2">
            <input
              id="includeHashtags"
              type="checkbox"
              className="form-checkbox h-5 w-5 text-text"
        ...
        <div className="border-t pt-10 mt-4">
        ...
        {/* <div className="border-t pt-4 mt-4"> 
            ...
            <div>
                <label htmlFor="imageUpload" className="block text-gray-700 text-sm font-medium mb-2">
            ...
            <div className="mt-4">
                <label htmlFor="imageTemplate" className="block text-gray-700 text-sm font-medium mb-2">
                    Template da Imagem:
                </label>
                <select
                    id="imageTemplate"
      ...
      {generatedContent && (
        <div className="mt-8 p-6 bg-card-light border border-border rounded-lg shadow-inner relative">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {" "}
            {/* Adicionado flex-wrap para quebra de linha em telas menores */}
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded text-sm flex items-center space-x-1"
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded text-sm flex items-center space-x-1"
            ...
            <button
              onClick={() => {
                ...
                toast.success(
                  "Texto para Instagram copiado! Cole na legenda e adicione a imagem."
                );
              }}
              className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded text-sm flex items-center space-x-1"
      ...
      {/* {generatedImageSrc && (
          <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg shadow-inner">
              ...
              <a 
                ...
                className="mt-4 inline-block bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                Download Imagem
              </a>
          </div>
